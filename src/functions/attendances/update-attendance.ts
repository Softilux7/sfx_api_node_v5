...
import { calcularAtendimentoCaso30 } from './calc-attendance'
...
export async function updateAttendanceFn(
  id: number,
  ID_BASE: number,
  progress: number,
  params: {
  ...
  switch (progress) {
    case 2: {
      ...
      if (updatedAtendimento.length === 0) {
        throw new AppError('Não foi possível atualizar o progresso [2]', 400)
      }
    ...
    case 3: {
      ...
      if (pauseBeforeClient.length === 0) {
        throw new AppError('Não foi possível atualizar o progresso [3]', 400)
      }
    ...
    case 4: {
      ...
      if (!updatedArrivalTrip || updatedArrivalTrip.length === 0) {
        throw new AppError('Não foi possível atualizar o progresso [4]', 400)
      }
    ...
    case 5: {
      ...
      if (pauseAfterClient.length === 0) {
        throw new AppError('Não foi possível atualizar o progresso [5]', 400)
      }
    ...
    case 6: {
      ...
      if (updatedInAttendance.length === 0) {
        throw new AppError('Não foi possível atualizar o progresso [6]', 400)
      }
    ...
    case 7: {
      ...
      if (pauseInAttendace.length === 0) {
        throw new AppError('Não foi possível atualizar o progresso [7]', 400)
      }
    ...
    case 8: {
      ...
      if (updatedFinishAttendance.length === 0) {
        throw new AppError('Não foi possível atualizar o progresso [8]', 400)
      }
    ...
    case 9: {
      ...
      if (updateAtendimentoChangePart.length === 0) {
        throw new AppError('Não foi possível atualizar o progresso [9]', 400)
      }
    ...
    case 10: {
      ...
      if (updatedFormAttendance.length === 0) {
        throw new AppError('Não foi possível atualizar o progresso [10]', 400)
      }
    ...
    case 11: {
      ...
      if (response.length === 0) {
        throw new AppError('Não foi possível atualizar o progresso [11]', 400)
      }
    ...
    case 15: {
      ...
      if (!cancelAttendance || cancelAttendance.length === 0) {
        throw new AppError('Não foi possível atualizar o progresso [15]', 400)
      }
    ...
    case 30:
      ...
      `
        ...
        if (!updatedAttendance || updatedAttendance.length === 0) {
          throw new AppError('Não foi possível atualizar o progresso [30]', 400)
        }
    ...
    case 23: {
      ...
      if (!returnBack || returnBack.length === 0) {
        throw new AppError('Não foi possível atualizar o progresso [23]', 400)
      }
    ...
    case 24: {
      ...
      if (!returnBack || returnBack.length === 0) {
        throw new AppError('Não foi possível atualizar o progresso [24]', 400)
      }
    ...
    default:
      throw new AppError('Progresso inválido.', 400)
  }
}
